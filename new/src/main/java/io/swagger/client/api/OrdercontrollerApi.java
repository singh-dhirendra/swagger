...
public class OrdercontrollerApi {
   ...
   */
  public ResponseEntity createBookingUsingPOST (Order order) throws ApiException {
    ...
    TypeRef returnType = new TypeRef<ResponseEntity>() {};
   ...
   * @return ResponseEntity
   */
  public ResponseEntity deleteBookingUsingDELETE (Integer orderId) throws ApiException {
    Object postBody = null;
    byte[] postBinaryBody = null;
    
     // verify the required parameter 'orderId' is set
     if (orderId == null) {
        throw new ApiException(400, "Missing the required parameter 'orderId' when calling deleteBookingUsingDELETE");
     }
